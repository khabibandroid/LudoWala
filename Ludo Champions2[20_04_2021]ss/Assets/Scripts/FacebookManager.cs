...
public class FacebookManager : MonoBehaviour
{
    ...
    public void startRandomGamePrivate(int player)
    {
        //		menuCanvas.SetActive (false);
        //		gameTitle.SetActive (false);
        ...
        //		matchPlayersCanvas.GetComponent <SetMyData> ().MatchPlayer ();
        //		matchPlayersCanvas.GetComponent <SetMyData> ().setBackButton (true);
        playFabManager.JoinRoomAndStartGamePrivate(player);
    }
    ...
    private void AuthCallback(ILoginResult result)
    {
        ...
        if (FB.IsLoggedIn)
        {
            ...
            GameManager.Instance.UserID = aToken.UserId;
    ...
    private void initSession()
    {
        ...
        {
            GameManager.Instance.UserID = AccessToken.CurrentAccessToken.UserId;
            callApiToGetName();
            getMyProfilePicture(GameManager.Instance.UserID);
