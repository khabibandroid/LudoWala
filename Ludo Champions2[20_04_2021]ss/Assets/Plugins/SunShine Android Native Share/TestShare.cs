...
public class TestShare : MonoBehaviour
{
    ...
    {
        SunShineNativeShare.ShareSingleFile(path, SunShineNativeShare.TYPE_IMAGE, "Share Message", "Share By sunshine");
    }

    public void ShareText()
    {
        SunShineNativeShare.ShareText("Share Message", "Share By sunshine");
    }


    private void shareMultipleFileOfSameType(string[] listOfPaths)
    {
        SunShineNativeShare.ShareMultipleFileOfSameType(listOfPaths, SunShineNativeShare.TYPE_IMAGE, "Share Message", "Share By sunshine");
