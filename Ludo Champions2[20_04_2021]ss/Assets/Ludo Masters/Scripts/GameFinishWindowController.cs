...
public class GameFinishWindowController : MonoBehaviour
{
    ...
    public void showWindow(List<PlayerObject> playersFinished, List<PlayerObject> otherPlayers, double firstPlacePrize, double secondPlacePrize, double ThirdPlacePrize)
    {
        ...
        prizeText[0].GetComponent<Text>().text = firstPlacePrize.ToString("0.00");
        prizeText[1].GetComponent<Text>().text = secondPlacePrize.ToString("0.00");
        prizeText[2].GetComponent<Text>().text = ThirdPlacePrize.ToString("0.00");
