...
namespace Toast.Kit.Common.Indicator.Internal
{
    public static class IndicatorField
    {
            ...
            Dictionary<string, string> customData)
        {
            ...
            sendData.Add(KEY_REQUIRED_PROJECT_VERSION, ToastKitCommon.VERSION);
            ...
            sendData.Add(KEY_CUSTOM_BODY, string.Format("[TOASTKit] {0} v{1}", serviceName, serviceVersion));
        ...
        {
            var jsonString = ToastKitJsonMapper.ToJson(dictionary);
